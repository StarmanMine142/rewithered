...
public class WorldgenDataEvents {
    ...
    public static void register() {
        if (Main.CONFIG.witherSkeletonTweaks.replaceSkeletonsInSoulSandValley.get()) Mixson.registerEvent(
        ...
        if (Main.CONFIG.witherSkeletonTweaks.replaceSkeletonsInFortress.get()) Mixson.registerEvent(
                Mixson.DEFAULT_PRIORITY,
